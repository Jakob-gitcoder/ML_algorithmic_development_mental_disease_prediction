...
This is a project is the outcome of three sequantially carried out master thesis projects from Syddansk Universitet (SDU), that has been developed over a two year period. The project is a part of a larger initiative that has been presented by the ACQUIRE-ICD foundation which is a collaboratory research-based project managed by OUH and SDU, which aims to increase patient related outcomes in relation to heart patients. For more information about this project and its organization use the following link: [ACQUIRE-ICD]([https://example.com](https://www.sdu.dk/en/om-sdu/institutter-centre/institut_psykologi/forskning/forskningsprojekter_/acquire-icd))
